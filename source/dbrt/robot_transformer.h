...
public:
     ...
     */
    RobotTransformer(
        const std::shared_ptr<RobotTransformsProvider>& state_publisher);
    ...
    /**
     * \brief Access to the transforms that were computed as by-product.
     */
     ...
     */
    void lookup_transform(const std::string& from,
                          const std::string& to,
...
protected:
    ...
    // This guy knows about the kinematics and can provide tf_transforms from
    // joints.
    ...
    // This guy knows how to build a tree of tf_transforms and do magical
    // lookups.
