...
#include <state_filtering/trackers/old_object_tracker.hpp>
...
{
public:
    Tracker(boost::shared_ptr<OldMultiObjectTracker> tracker): tracker_(tracker), node_handle_("~")
    {
...
private:
    boost::shared_ptr<OldMultiObjectTracker> tracker_;
...
int main (int argc, char **argv)
{
    ...
    if(source == "camera")
    {
        ...
        boost::shared_ptr<OldMultiObjectTracker> tracker(new OldMultiObjectTracker);
