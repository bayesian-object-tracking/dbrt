...
OldMultiObjectTracker::OldMultiObjectTracker():
        node_handle_("~"),
...
void OldMultiObjectTracker::Initialize(
...
Eigen::VectorXd OldMultiObjectTracker::Filter(const sensor_msgs::Image& ros_image)
{
    boost::mutex::scoped_lock lock(mutex_);
